...
//  2023-07-18: Inputs: Revert ignoring mouse resources on GLFW_CURSOR_DISABLED as it can be used differently. User may set ImGuiConfigFLags_NoMouse if desired. (#5625, #6609)
...
//  2021-06-29: Reorganized backend to pull resources from a single structure to facilitate usage with multiple-contexts (all g_XXXX access changed to bd->XXXX).
...
// Backend resources stored in io.BackendPlatformUserData to allow support for multiple Dear ImGui contexts
...
static bool ImGui_ImplGlfw_Init(GLFWwindow* window, bool install_callbacks, GlfwClientApi client_api)
{
    ...
    // Set platform dependent resources in viewport
